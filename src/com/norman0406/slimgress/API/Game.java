...
{    
    ...
    public void updateLocation(Utils.LocationE6 location)
    {
        mLocation = location;
    }
    
    public final Utils.LocationE6 getLocation()
    {
        return mLocation;
    }
    ...
    public void intChooseFaction(final Utils.Team team, final Handler handler)
    {
    	try {
    		checkInterface();
    ...
    public void intDropItem(Item item, final Handler handler)
    {
    	try {
    		checkInterface();
    ...
    public void intRecycleItem(Item item, final Handler handler)
    {
    	try {
    		checkInterface();
